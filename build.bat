...
set GOOS=windows
set GOARCH=amd64
go build -ldflags="%LDFLAGS%" -o dist/code2txt-windows-amd64.exe

REM Linux AMD64
echo Building Linux AMD64...
set GOOS=linux
set GOARCH=amd64
go build -ldflags="%LDFLAGS%" -o dist/code2txt-linux-amd64

REM macOS Intel
echo Building macOS Intel...
set GOOS=darwin
set GOARCH=amd64
go build -ldflags="%LDFLAGS%" -o dist/code2txt-macos-intel

REM macOS Apple Silicon
echo Building macOS Apple Silicon...
set GOOS=darwin
set GOARCH=arm64
go build -ldflags="%LDFLAGS%" -o dist/code2txt-macos-arm64
